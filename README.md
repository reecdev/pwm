...
## Use cases
pwm can be useful if you have a ton of projects you want to publish but you're too lazy to make docs for. For example, you could spin up 5 or 10 instances of pwm at once to write docs for every single project in parallel. (hence the name: Parallel Worker Manager)
